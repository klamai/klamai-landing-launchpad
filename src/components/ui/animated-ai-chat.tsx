...
export function AnimatedAIChat() {
    ...
    return (
        <div className="min-h-screen flex flex-col w-full items-center justify-center bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white p-6 relative overflow-hidden">
            ...
            <AnimatePresence>
                {isTyping && (
                    <motion.div 
                        className="fixed bottom-8 left-1/2 transform -translate-x-1/2 backdrop-blur-2xl bg-white/90 dark:bg-gray-800/90 rounded-full px-4 py-2 shadow-lg border border-gray-200 dark:border-gray-700"
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
                        exit={{ opacity: 0, y: 20 }}
                    >
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
                                <span>klamAI está procesando</span>
                                <TypingDots />
                            </div>
                        </div>
                    </motion.div>
