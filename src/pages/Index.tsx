...
import { StableAnimatedGroup } from "@/components/ui/stable-animated-group";
import { Testimonial } from "@/components/ui/testimonial-card";
import { FeaturesSectionWithHoverEffects } from "@/components/ui/feature-section-with-hover-effects";
import { FooterSection } from "@/components/ui/footer-section";
import { PromptInput, PromptInputTextarea, PromptInputActions, PromptInputAction } from "@/components/ui/prompt-input";
import { LoadingSkeleton, ContentSkeleton } from "@/components/ui/loading-skeleton";
...
import { useAuth } from "@/hooks/useStableAuth";
...
const Index = () => {
  ...
  useEffect(() => {
    // Ensure page is ready after auth is initialized
    if (initialized) {
                ...
                <div className="mb-20" id="testimonials">
                  ...
                  <div className="grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                    {testimonials.map(testimonial => (
                      <ErrorBoundary key={testimonial.name}>
