    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <Button asChild className="bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700">
                <Link to="/chat">Consultar Ahora</Link>
              </Button>
            </nav>
          ...
          {mobileMenuOpen && (
            <nav className="md:hidden mt-4 pb-4 border-t pt-4">
              <div className="flex flex-col space-y-2">
                <Link to="/" className="text-gray-600 hover:text-blue-600 font-medium transition-colors py-2">
                  Inicio
                </Link>
                <Link to="/chat" className="text-gray-600 hover:text-blue-600 font-medium transition-colors py-2">
                  Chat con VitorIA
                </Link>
                <a href="#features" className="text-gray-600 hover:text-blue-600 font-medium transition-colors py-2">
                  Características
                </a>
                <a href="#testimonials" className="text-gray-600 hover:text-blue-600 font-medium transition-colors py-2">
                  Testimonios
                </a>
                <Button asChild className="bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 mt-4">
                  <Link to="/chat">Consultar Ahora</Link>
                </Button>
              </div>
            </nav>
      ...
      <main className="container mx-auto px-4 py-12 max-w-4xl">
        <div className="prose prose-lg max-w-none">
          <h1 className="text-3xl font-bold text-gray-900 mb-8">Aviso Legal de Klamai.com</h1>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">1. Identificación del Responsable</h2>
            <p className="text-gray-700 mb-4">
              El Sitio Web es operado por:
            </p>
            <div className="bg-gray-50 p-6 rounded-lg">
              <p className="text-gray-700 mb-2"><strong>Klamai (RW ALIVALCA S.L.)</strong></p>
              <p className="text-gray-700 mb-2"><strong>Dirección:</strong> Plaza Portal de Elche nº 6 -1º, Alicante 03003, España</p>
              <p className="text-gray-700 mb-2"><strong>Correo electrónico:</strong> gestiones@klamai.com</p>
              <p className="text-gray-700 mb-2"><strong>CIF/NIF:</strong> B42704593</p>
              <p className="text-gray-700"><strong>Inscrita en:</strong> [Registro Mercantil de Alicante, datos específicos a completar si están disponibles]</p>
            </div>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">4. Facturación de Servicios</h2>
            <p className="text-gray-700">
          ...
          <section className="mb-8">
            ...
            <div className="mb-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-3">5.1. Responsabilidad de Klamai</h3>
              <p className="text-gray-700 mb-4">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-3">5.2. Responsabilidad del Usuario</h3>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">6. Propiedad Intelectual e Industrial</h2>
            <p className="text-gray-700 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">7. Uso de Inteligencia Artificial</h2>
            <p className="text-gray-700">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">9. Protección de Datos</h2>
            <p className="text-gray-700">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">10. Modificaciones del Aviso Legal</h2>
            <p className="text-gray-700">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">11. Legislación y Jurisdicción</h2>
            <p className="text-gray-700">
          ...
          <section className="mb-8">
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              <p className="text-gray-700 mb-2"><strong>Correo electrónico:</strong> gestiones@klamai.com</p>
              <p className="text-gray-700"><strong>Dirección:</strong> Plaza Portal de Elche nº 6 -1º, Alicante 03003, España.</p>
            </div>
          </section>
        </div>
      </main>
